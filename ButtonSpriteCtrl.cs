...
public class ButtonSpriteCtrl : MonoBehaviour
{
    public GameManager gM;
    public List<Card> currentPlayer;
    ...
    void Update()
    {
        currentPlayer = gM.getCurrentPlayerHand();
        if (index < currentPlayer.Count)
        {
            cardImage.enabled = true;
            currentCard = currentPlayer[index];
